...
function App() {
  ...
  let one_data = [];
  axios.get('https://prevexam.dece.nycu.edu.tw/api/get-one-data').then((response) => {
    one_data = response.data
  })

  let two_data = [];
  axios.get('https://prevexam.dece.nycu.edu.tw/api/get-two-data').then((response) => {
    two_data = response.data
  })

  let advance_data = [];
  axios.get('https://prevexam.dece.nycu.edu.tw/api/get-advance-data').then((response) => {
    advance_data = response.data
  })

  let other_data = [];
  axios.get('https://prevexam.dece.nycu.edu.tw/api/get-other-data').then((response) => {
  ...
  const Logout = () => {
    fetch("https://prevexam.dece.nycu.edu.tw/api/logout", {
      method: "GET",
      credentials: 'include'
    })
  ...
  useLayoutEffect(() => {
    const loginCheck = async () => {
      await fetch("https://prevexam.dece.nycu.edu.tw/api/login-status-check", {
        method: "GET",
        credentials: 'include'
      }).then(response => {
        if (response.ok) {
